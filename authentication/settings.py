...
SECRET_KEY = '&=q@67j*uknvkn^7b9g1nfxg8&lxn*2omn6!@%!$ua-e^t6zbv'
...
INSTALLED_APPS = [
    ...
    # TODO: Add the new authentication app
    'microsoft_authentication.apps.MicrosoftAuthenticationConfig',
]
...
MICROSOFT = {
    ...
    "valid_email_domains": ["onmicrosoft.com", "outlook.com"],
